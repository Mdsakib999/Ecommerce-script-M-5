import { CheckCircle, Clock, Home, Search, Truck, XCircle } from "lucide-react";
  ...
  return (
    <div className="flex pt-16 items-center justify-center p-4">
      <div className="w-full max-w-2xl">
        ...
        <div className="mb-8 flex justify-between flex-row-reverse items-center">
          <div className="">
            <img className="w-24 h-24" src={track} alt="" />
          </div>
          <div className="">
        ...
        {/* Search Input */}
        <div className="bg-white flex flex-col gap-6 rounded-lg mb-6">
          <div className="">
            <div className="flex-grow relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-3 py-4 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500"
                value={trackingId}
              ...
              />
                              ...
                              <button
              onClick={handleTrack}
              className="bg-primary w-max mx-auto inline-block  text-white font-medium px-10 py-4 hover:bg-secondary cursor-pointer transition-all duration-300 rounded-lg disabled:bg-gray-400"
              disabled={isFetching}
            >
