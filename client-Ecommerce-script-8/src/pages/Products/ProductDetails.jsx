...
import {
  ...
  useGetProductQuery,
} from "../../redux/app/services/product/productApi";
...
export default function ProductDetails() {
  ...
  const { data: productsData } = useGetAllProductQuery(params);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-3xl border-1 border-gray-300 overflow-hidden mb-16">
        ...
        {/* Tabs Section */}
        <div className="bg-white rounded-3xl border-1 border-gray-300 p-8">
          {/* Tabs Navigation */}
        ...
        {sameCategoryProducts.length ? (
          <div className="">
            {/* Header */}
            <div className="mt-16 border-b border-primary pb-4 mb-12">
              <h1 className="text-secondary font-semibold text-4xl">
                {sameCategoryProducts.length} Other products in the same
                category
              </h1>
            </div>
        ...
        <div className="">
          {/* Header */}
          <div className="mt-16 border-b border-primary pb-4">
            <h1 className="text-secondary font-semibold text-4xl">
              You might also like
            </h1>
          </div>
