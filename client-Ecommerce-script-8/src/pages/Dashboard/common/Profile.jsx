import { Plus, ShieldCheck, User, UserPen } from "lucide-react";
    ...
    <div className="w-full max-w-5xl mx-auto mt-12">
      <div className="bg-whiteoverflow-hidden">
        ...
        <div className="flex justify-center items-center">
          <div className="p-8 flex w-full flex-col md:justify-between md:flex-row-reverse items-center md:p-10 lg:p-8">
            ...
            <div className="text-center md:text-left">
              ...
              <h4 className="text-4xl mt-4 font-semibold text-gray-900">
                {profile.name}
              </h4>
            </div>
          </div>
        ...
        {/* Profile Content */}
        <div className="p-8 bg-secondary-light rounded-lg mt-4">
          <div className="flex justify-between items-start sm:items-center mb-8">
            ...
            <button
              onClick={() => setOpenModal(true)}
              className="flex items-center cursor-pointer gap-2 px-5 py-2 text-xs md:text-sm bg-primary text-white rounded-lg hover:bg-secondary transition-all shadow-sm"
            >
