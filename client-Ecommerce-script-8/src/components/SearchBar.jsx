    ...
    <div className="relative w-full max-w-lg mx-auto">
      <div className="flex items-center">
        <input
          ...
          className="w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg bg-gray-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-transparent transition-all duration-200 text-gray-700 placeholder-gray-500"
        />
        <button className="absolute right-0 top-1/2 transform -translate-y-1/2 p-2 text-white bg-primary px-4 py-4 rounded-r-lg transition-colors duration-200">
